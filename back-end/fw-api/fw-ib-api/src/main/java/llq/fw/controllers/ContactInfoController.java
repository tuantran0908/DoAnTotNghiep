...
public class ContactInfoController {
	...
	public ResponseEntity<BaseResponse> searchAll(ContactInfoSearchRequest contactInfoRequest,Pageable pageable) {
		BaseResponse baseResponse=contactInfoServiceImpl.search(contactInfoRequest, pageable);
		return ResponseEntity.ok(baseResponse);
	}
	@PostMapping // Tao moi 
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<BaseResponse> create(@RequestBody ContactInfo contactInfoRequest) {
		BaseResponse baseResponse=contactInfoServiceImpl.create(contactInfoRequest);
		return ResponseEntity.ok(baseResponse);
	}
	@PutMapping // Cap nhat 
	public ResponseEntity<BaseResponse> update(@RequestBody ContactInfo contactInfoRequest) {
